...
const FooterMapCard = () => {
    return (
      ...
      <div className="container z-2">
        <div
          className="row position-relative justify-content-center align-items-cente"
        >
              ...
              <div className="card-body text-left px-5 py-4">
                <div className="row align-items-center">
                  <div className="col-md-5">
                      ...
                      <div className="col">
                        <ul className="list-group mb-3">
                          ...
                          <li className="list-group-item p-0">
                            <a href="../html/all-spaces.html"
                              >All cities<span
                                className="fas fa-arrow-right fa-xs ml-2"
                              ></span
                            ></a>
                          </li>
                        </ul>
                    ...
                    <a
                      href="../html/submit-item.html"
                      className="btn btn-secondary animate-up-2"
                      ><span className="fas fa-plus mr-2"></span>List a Space</a
                    >
                  </div>
                  <div
                    className="
